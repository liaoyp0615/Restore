    ...
    if doTraining:
        ...
        for epoch in range(epochs):
            ...
            if epoch % 1 == 0 and saveCkpt:
                ...
                print('g_loss_list= ',sum(g_loss_list)/len(g_loss_list))
                print('d_real_loss_list= ',2*sum(d_real_loss_list)/len(d_real_loss_list))
                print('d_fake_loss_list= ',2*sum(d_fake_loss_list)/len(d_fake_loss_list))
