...
from __future__ import print_function #use functions from advanced edition of python

import argparse #用来方便地读取命令行参数
from collections import defaultdict #为字典提供默认值 ; 还可以被用来计数，将default_factory设为int即可。 
import logging #日志模块 
...
"""----------------------set up all arguments and log debugs----------------------------""" 
